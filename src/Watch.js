...
console.log(response2);
      const videoUrl = "https://hianime-coral.vercel.app/m3u8-proxy?url="+response2.data.content.data.sources[0].url;
	//pl//
...
//const player = new Plyr('#player', {
  ...
  { headers: { 'Content-Type': 'application/json' } }
        ...
        const videoUrl = "https://hianime-coral.vercel.app/m3u8-proxy?url="+sources[0].url;
